 ...
 * file '/cygdrive/c/intelFPGA/16.1/embedded/projects/time_tagger/fpga-rtl/soc_system.sopcinfo'.
 */
...
#define SYSID_QSYS_TIMESTAMP 1501487686

/*
 * Macros for device 'slave_template_0', class 'slave_template'
 * The macros are prefixed with 'SLAVE_TEMPLATE_0_'.
 * The prefix is the slave descriptor.
 */
#define SLAVE_TEMPLATE_0_COMPONENT_TYPE slave_template
#define SLAVE_TEMPLATE_0_COMPONENT_NAME slave_template_0
#define SLAVE_TEMPLATE_0_BASE 0x11000
#define SLAVE_TEMPLATE_0_SPAN 2048
#define SLAVE_TEMPLATE_0_END 0x117ff
